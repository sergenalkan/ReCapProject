...
{// Projeme yükleyeceğim dosyalarla ilgili yükleme,silme,güncelleme işlemlerini bu class'ımda yapıyorum.
    ...
    public class FileHelperManager : IFileHelper
    {
        ...
        public string Upload(IFormFile file, string root)
        {
            ...
            {
                if (!Directory.Exists(root))//Directory=>System.IO'nın bir class'ı. burada ki işlem tam olarak şu. Bu Upload metodumun parametresi olan string root CarImagerManager'dan gelmekte
